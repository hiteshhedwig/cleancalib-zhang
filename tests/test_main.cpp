...
int main() {
    ...
    register_homography_tests();
    register_zhang_tests();
    register_refinement_tests();
    register_harris_tests();
    register_checkerboard_detector_tests();
    register_real_checkerboard_tests();
